...
const AdForm = ({ action, actionText, ...props }) => {
  ...
  const handleSubmit = (e) => {
    if (
      removeTags(content).length < 20 ||
      removeTags(content).length > 500 ||
      !photo
    ) {
  ...
  return (
    <Form onSubmit={validate(handleSubmit)} className={styles.adForm}>
      ...
      <Form.Group controlId="formLocalization" className={styles.formGroup}>
        ...
        {errors.localization && (
          <small className="d-block form-text text-danger mt-2">
            This field is required! Please, enter localization!
          </small>
        )}
      </Form.Group>
      ...
      <Form.Group controlId="formPrice" className={styles.formGroup}>
        ...
        <Form.Control
          ...
          {...register("price", {
            ...
            pattern: {
              value: /^[0-9]*$/,
              message: "Only numeric values are allowed for the price field!",
            },
          })}
          value={price}
        ...
        {errors.price && errors.price.type === "required" && (
          <small className="d-block form-text text-danger mt-2">
            This field is required! Please enter the price.
          </small>
        )}
